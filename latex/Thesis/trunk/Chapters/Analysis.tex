...
%		column type=r,
		...
		columns/Self/.style={column name=\slcsmallcaps{Self (\%)}},
		columns/Total/.style={column name=\slcsmallcaps{Total (\%)}},
		columns/Symbol/.style={string type, column type=l, column name=\slcsmallcaps{Symbol}},
		columns/{Size (KB)}/.style={column name=\slcsmallcaps{Size (KB)}},
...
of the image for processing. The mean shift algorithm takes 
