...
%			xticklabel={$2^14$, $2^15$},
  ...
  %    \closedcycle;
      ...
      \addplot[color=pl0,fill=pf0,mark=none] table[x=PIX,y={GPU}] from \tableA;
...
%			ytick={0,0.5,1,1.5},
      ...
      ymajorgrids,
 			...
 			\addplot[color=plot1!40!white,fill=plot1!40!white] table[x=PIX,y=CPU_Speedup] from \tableB;
 			\addplot[color=plot0!40!white,fill=plot0!40!white] table[x=PIX,y=Speedup] from \tableA;
