...
The effect of different bandwidth parameters $h$ (search window radius) is shown in 
...
%		ymajorgrids
		...
		\addplot[mark=none] table[x=X,y=Y5] from \tableA;
		\addplot[mark=none] table[x=X,y=Y1] from \tableA;
		\addplot[mark=none] table[x=X,y=Y_1] from \tableA;
		\addplot[mark=none] table[x=X,y=Y_4] from \tableA;
		\addplot[mark=none] table[x=X,y=Y_5] from \tableA;
		\addplot[mark=none] table[x=X,y=SUMME] from \tableA;
...
%		ymajorgrids
		...
		\addplot[mark=none] table[x=X,y=Y5] from \tableB;
		\addplot[mark=none] table[x=X,y=Y1] from \tableB;
		\addplot[mark=none] table[x=X,y=Y_1] from \tableB;
		\addplot[mark=none] table[x=X,y=Y_4] from \tableB;
		\addplot[mark=none] table[x=X,y=Y_5] from \tableB;
		\addplot[mark=none] table[x=X,y=SUMME] from \tableB;
...
%		ymajorgrids
		...
		\addplot[mark=none] table[x=X,y=Y5] from \tableC;
		\addplot[mark=none] table[x=X,y=Y1] from \tableC;
		\addplot[mark=none] table[x=X,y=Y_1] from \tableC;
		\addplot[mark=none] table[x=X,y=Y_4] from \tableC;
		\addplot[mark=none] table[x=X,y=Y_5] from \tableC;
		\addplot[mark=none] table[x=X,y=SUMME] from \tableC;
...
%		ymajorgrids
		...
		\addplot+[const plot] 
			coordinates { (-1,0) (-1,0.5) (1,0.5) (1,0) };
	\end{axis}
\end{tikzpicture}
...
The third step involves shifting the kernel window with the mean shift vector 
