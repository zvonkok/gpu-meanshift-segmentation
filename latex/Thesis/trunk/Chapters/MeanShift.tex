  ...
  \subfloat[Epanechnikov]{
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[color=plot0] expression[domain=-1:1] {3/4*(1-x*x)};
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[color=plot1] expression[domain=-3:3]
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+[const plot,color=plot2] coordinates { (-1,0) (-1,0.5) (1,0.5)
          (1,0) };
      \end{axis}
    \end{tikzpicture}
