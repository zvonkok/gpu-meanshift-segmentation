...
power \gls{MGCP}:143 idle:62 3d:165  ref:http://www.tomshardware.com/de/Grafikkarte-Leistungsbedarf-Strombedarf-Netzteil-Auswahl,testberichte-240205-4.html

624 \glspl{GFLOP} \unitfrac[62.1]{\gls{GB}}{s}

architecture the same as the tesla except the main memory and bandwidht
