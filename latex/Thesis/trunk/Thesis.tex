...
fontsize=11pt,footinclude,cleardoublepage=empty,abstract=false % <--- obsolete, remove (todo)
  ]{scrreprt}
% ********************************************************************
...
\newcommand{\myName}{Zvonko Krnjajic\xspace}
...
%*******************************************************
\usepackage[xetex]{classicthesis-ldpkg} 
%*******************************************************
...
%%%\usepackage[eulerchapternumbers,drafting,xetex,
%%%            subfig,eulermath,parts]{classicthesis}
\usepackage[drafting,xetex,listings,
